...
<title>Production Laitier || Insertion Achat</title>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Insertion achat matiere premiere</h2>
                    <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" action="<?php echo base_url('Matiere/insertAchat'); ?>" method="get">
                                <div class="form-group form-float">
                                    <select type="text" class="form-control" placeholder="Matiere" name="matiere">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="help-info">Quantite Achete</div>
                                </div>
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" name="prix" required>                                
                                    <div class="help-info">Prix d'Achat</div>
                                </div>
