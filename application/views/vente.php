...
<title>Production Laitier || Vente Produit</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Vente</strong> Produit fini</h2>
                            
                        </div>
                        <div class="body">
                            <form id="form_advanced_validation" action="<?php echo base_url('Produit/insertionVente'); ?>" method="get">
                                ...
                                <button class="btn btn-raised btn-primary waves-effect" type="submit">Vendre</button>
                            </form>
                        </div>
                    </div>
                </div>
